...
#define PIN_FREQ_TEST    18   // Internal test frequency output
...
// ── Internal Frequency Test Generator ──
void setupFrequencyTest()
{
  ledcSetup(0,1000,8);
  ledcAttachPin(PIN_FREQ_TEST,0);
  ledcWrite(0,128);
}
